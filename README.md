## mrpt_path_planning (noetic) - 0.2.1-1

The packages in the `mrpt_path_planning` repository were released into the `noetic` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r noetic mrpt_path_planning` on `Mon, 14 Oct 2024 19:17:28 -0000`
